...
"       terminal,  it [4mdisables[24m the progress meter as otherwise it would mess up\n"
...
"\n"
"              [4m-d/--data[24m  is  the  same  as  [4m--data-ascii[24m.  To post data purely\n"
, stdout);
 fputs(
...
"\n"
"              Since  curl 7.19.0, [1m--eprt [22mcan be used to explicitly enable EPRT\n"
"              again and [1m--no-eprt [22mis an alias for [1m--disable-eprt[22m.\n"
"\n"
...
"              not try using EPSV.\n"
"\n"
"              Since  curl 7.19.0, [1m--epsv [22mcan be used to explicitly enable EPRT\n"
, stdout);
 fputs(
"              again and [1m--no-epsv [22mis an alias for [1m--disable-epsv[22m.\n"
"\n"
...
"              tificate  concatenated!  See  [4m--cert[24m  and  [4m--key[24m to specify them\n"
, stdout);
 fputs(
"              independently.\n"
"\n"
...
"              supplied with openssl. Using [4m--capath[24m can  allow  curl  to  make\n"
"              SSL-connections much more efficiently than using [4m--cacert[24m if the\n"
"              [4m--cacert[24m file contains many CA certificates.\n"
"\n"
"              If this option is used several times, the last one will be used.\n"
"\n"
"       -f/--fail\n"
...
"              [4m-d/--data[24m  or  [4m--data-binary[24m  to  be  used in a HTTP GET request\n"
...
"              single  request's  maximum  time,  use  [4m-m/--max-time[24m.  Set this\n"
...
, stdout);
 fputs(
"              Examples:\n"
"               --socks5  proxy-name  [4m--socks5-gssapi-service[24m sockd   would use\n"
"              sockd/proxy-name\n"
"               --socks5  proxy-name  [4m--socks5-gssapi-service[24m   sockd/real-name\n"
...
"              option  [4m--socks5-gssapi-nec[24m  allows  the unprotected exchange of\n"
...
"              [4m-i/--include[24m might be the option you're looking for.\n"
"\n"
...
"              from a given file name  instead!  See  the  [4mcurl_getdate(3)[24m  man\n"
